...
function MenuLace({ activeSection }) {
  const { laceColor, setLaceColor } = useCustomization();
              ...
              >
                <button
                  ...
                  className={[
                    ...
                    laceColor.key === color.key ? 'active' : '',
                  ].join(' ')}
                  style={{
                ...
                <span
                  className={[
                    ...
                    laceColor.key === color.key ? 'block' : 'hidden',
                  ].join(' ')}
                >
                  {color.name}
                </span>
